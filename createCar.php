...
if (isset($_POST["sub"])) {
    ...
    if (isset($_FILES["image"]) && $_FILES["image"]["error"] == 0) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $uploadFile)) {
            ...
            // Ajout de la voiture
            $result=$voitureManager->addVoiture($prix, $nom, $description, $kilometrage, $annee, $image);
...
<div>
    ...
    <form method="POST" enctype="multipart/form-data"
        ...
        <div class="flex flex-col py-2">
            ...
            <label class="block mb-2 text-sm font-medium text-secondary dark:text-white" for="image">Image mise en avant
                :</label>
            <input type="file" name="image" id="image" accept="image/*" required
                class="block w-full text-md text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-500 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 md:rounded-lg">
