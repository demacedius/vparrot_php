...
if(isset($_POST["sub"])){
    ...
    if(isset($_FILES["image"]) && $_FILES["image"]["error"]==0){
        ...
        $nom_photo=$prix.".".$extension_upload;
        ...
        $sql="INSERT INTO `voiture` (`prix`,`kilometrage`,`annee_mise_en_circulation`,`image_mise_en_avant`) VALUES ('$prix','$kilometrage','$annee','$ph_name')";
